...
String packagesData[2][3] = { {"108240179204", "40.946525", "-74.110275"}, {"92247228205", "40.946620", "-74.110351"} };
...
void checkpackageforDelivery(int packageSpot, String packageId)
{
  ...
  for (packageNumber = 0; packageNumber <= 1; packageNumber++) {
    if (packageId == packagesData[packageNumber][0]) {
      ...
      if ((latDifference <= 0.00005) && (longDifference <= 0.00005)) //if distance is in radius of 2 Meters
      {
